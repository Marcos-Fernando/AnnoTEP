...
var elementsWithDarkTheme = document.querySelectorAll('.main, .Download, .Help, .About, .Contact, .container-main, .box-checkboxs, .container-threads, .box-explicative, .title-input, .session-title, .header, .footer, .rectangle-green, .uploaddata, .img-dna, .img-phylogeny, .item-download, .icon-download, .container-download, .documentation-annotep, .description-about, .description-contact, .num_work');
