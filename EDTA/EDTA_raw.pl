...
if ($overwrite eq 0 and -s "$genome.LTR.raw.fa"){
	...
	if (! -e "$genome.LTR.intact.raw.fa"){
		...
		if ( -z "pick.sh" ) {
			...
			`bash pick.sh | sed 's#_DOIS_#:#g' | sed 's#--#..#g' | sed 's/__/#/g' | sed 's#_#/#g' | sed 's#/END##g' | sed 's#Copia/mixture#Copia#g' | sed 's#Gypsy/mixture#Gypsy#g' | sed 's#LTR/mixture#LTR/Unknown#g' | sed 's#mixture#Unknown#g' | sed 's#Copia/Unknown#Copia#g' | sed 's#Gypsy/Unknown#Gypsy#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#pararetrovirus#LTR/Unknown#g' > $genome.LTR.intact.raw.fa` ; 
		...
		if ( -z "pick.sh" ) {
			...
			`bash pick.sh | sed 's#_DOIS_#:#g' | sed 's#--#..#g' | sed 's/__/#/g' | sed 's#_#/#g' | sed 's#/END#-like#g' | sed 's#LTR/Gypsy#TR_GAG/Gypsy#g' | sed 's#LTR/Copia#TR_GAG/Copia#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#pararetrovirus#LTR/Unknown#g' >> $genome.LTR.intact.raw.fa` ; 
			`cat pick.sh | sed 's#^cat #rm #g' > del.sh`;
			`bash del.sh`;
		} 
		#
		...
		if ( -z "pick.sh" ) {
			...
			`bash pick.sh | sed 's#_DOIS_#:#g' | sed 's#--#..#g' | sed 's/__/#/g' | sed 's#_#/#g' | sed 's#/END#-like#g' | sed 's#LTR/Gypsy#BARE-2/Gypsy#g' | sed 's#LTR/Copia#BARE-2/Copia#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#pararetrovirus#LTR/Unknown#g' >> $genome.LTR.intact.raw.fa` ; 
			`cat pick.sh | sed 's#^cat #rm #g' > del.sh`;
			`bash del.sh`;
		} 
		#
		...
		if ( -z "pick.sh" ) {
			...
			if ( -z "pick2.sh" ) {
				...
				`bash pick2.sh | sed 's#_DOIS_#:#g' | sed 's#--#..#g' | sed 's/__/#/g' | sed 's#_#/#g' | sed 's#/END#-like#g' | sed 's#LTR/mixture-like#LTR/Unknown#g' | sed 's#mixture-like#Unknown#g' | sed 's#pararetrovirus-like#pararetrovirus#g' | sed 's#Gypsy-like#Gypsy#g' | sed 's#Copia-like#Copia#g' | sed 's#Copia/Unknown#Copia#g' | sed 's#Gypsy/Unknown#Gypsy#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#pararetrovirus#LTR/Unknown#g' >> $genome.LTR.intact.raw.fa` ; 
		...
		if ( -z "temp3.fa" ) {
			...
			`pullseq -i temp3.fa -m 4000 | sed 's#LTR/Copia#LARD#g' | sed 's#LTR/Gypsy#LARD#g' | sed 's#LTR/unknown#LARD#g' | sed 's#Unknown#LARD#g' >> $genome.LTR.intact.raw.fa` ; 

			`pullseq -i temp3.fa -a 3999 | sed 's#LTR/Copia#TRIM#g' | sed 's#LTR/Gypsy#TRIM#g' | sed 's#LTR/unknown#TRIM#g' | sed 's#Unknown#TRIM#g' >> $genome.LTR.intact.raw.fa` ; 
		...
		if ($test_dir > 0) {
			`cat TMP/*.fasta | sed 's#_DOIS_#:#g' | sed 's#--#..#g' | sed 's/__/#/g'  | sed 's#_END##g' | sed 's#LTR_mixture#LTR/Unknown#g' | sed 's#mixture#LTR/Unknown#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#pararetrovirus#LTR/Unknown#g' >> $genome.LTR.intact.raw.fa`;
		}
		#
