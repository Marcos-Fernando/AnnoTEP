...
if ($sensitive == 1 and -s "$genome.RM2.fa"){
	...
	if (-s "$genome.RM2.fa.stg1.clean"){
		...
		# ======================================
		#
		`cat $genome.RepeatModeler.raw.tmp | sed 's#Copia/mixture#Copia#g' | sed 's#Gypsy/mixture#Gypsy#g' | sed 's#LTR/mixture#LTR/Unknown#g' | sed 's#mixture#Unknown#g' | sed 's#Copia/Unknown#Copia#g' | sed 's#Gypsy/Unknown#Gypsy#g' | sed 's#LTR/pararetrovirus#pararetrovirus#g' | sed 's#-outgroup##g' | sed 's#unknown#Unknown#g' | sed 's#Penelope-like#Penelope#g' | sed 's#DIRS-like#DIRS#g' | sed 's#LTR/Sola1#TIR/Sola1#g' | sed 's#LTR/Sola2#TIR/Sola2#g' | sed 's#LTR/Sola3#TIR/Sola3#g'> TMP.RepeatModeler.raw.tmp`;		
		#
