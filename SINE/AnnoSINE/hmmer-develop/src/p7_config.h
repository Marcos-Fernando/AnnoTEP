...
#ifdef eslENABLE_SSE           // Our experimental FM-index code in nhmmer requires SSE vectorization.
#define p7ENABLE_FMINDEX       //  ... Turn it on whenever we have SSE vectorization available.
#else
/* #undef p7ENABLE_FMINDEX */
#endif
