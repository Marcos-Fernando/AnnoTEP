...
##                                                                      ##
  ...
  $configuration = {
          ...
          'LIBDIR' => {
                        ...
                        'param_type' => 'directory',
                        'required' => 0,
                        'value' => '/home/amvarani/AnnoTEP/AnnoTEP_v1/ProcessRepeats/Libraries'
                      },
          'RMBLAST_DIR' => {
                             ...
                             'param_type' => 'directory',
                             'required' => 0,
                             'value' => '/home/amvarani/miniconda3/envs/EDTA-new/bin'
                           },
          'TRF_PRGM' => {
                          ...
                          'param_type' => 'program',
                          'required' => 1,
                          'value' => '/home/amvarani/miniconda3/envs/EDTA-new/bin/trf'
                        }
        };
