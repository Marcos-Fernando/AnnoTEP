...
var elementsWithDarkTheme = document.querySelectorAll('.main, .Download, .container-main, .box-checkboxs, .box-explicative, .title-input, .session-title, .header, .footer, .rectangle-green, .uploaddata, .img-dna, .img-phylogeny, .item-download, .icon-download, .description-download');
