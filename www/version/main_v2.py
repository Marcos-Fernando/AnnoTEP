...
def annoMSC(new_filename, folderSINE, seedSINE, folderEDTA, libLINE):
    ...
    cd {folderEDTA}
    nohup {EDTA_FOLDER}/EDTA.pl --genome ../../input/{new_filename} --species others --step all --line ../../sine-line/{libLINE} --sine ../../sine-line/{seedSINE} --sensitive 1 --anno 1 --threads 10 > EDTA.log 2>&1 &
